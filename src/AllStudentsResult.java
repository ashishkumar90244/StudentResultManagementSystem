...
public class AllStudentsResult extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        all.setForeground(new java.awt.Color(204, 0, 0));
    ...
    private void formComponentShown(java.awt.event.ComponentEvent evt) {//GEN-FIRST:event_formComponentShown
        ...
        try{
            ...
            ResultSet rs = st.executeQuery("select Student.Name , Student.RollNumber,Result.Mathematics,Result.Physics,Result.Chemistry , Result.Electrical ,Result.Electronic from Result Inner join Student on Student.RollNumber=Result.RollNumber");
